...
if __name__ == '__main__':
    ...
    parser.add_argument('save_path', help='test data (format: timestamp data)(suffix: .txt')
    ...
    test_xyz_full_aligned = scale * rotation * test_xyz_full + translation_gt

    np.savetxt(args.save_path, test_xyz_full_aligned.transpose())
    #
